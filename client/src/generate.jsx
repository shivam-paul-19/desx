function generater(fabricCanvas) {
    ...
    fabricCanvas.forEach(obj => {
        ...
        // TODO
            ...
            let imgSrc = obj._element.src.length > 100 ? obj._element.src.substring(0, 100) + "..." : obj._element.src;
            html += `<img src="${imgSrc}" style="width:${width}px; height:${height}px; ${style}">\n`;
        }
    });
